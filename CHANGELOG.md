...
- **Icon set grown to 420+ glyphs.** The hand-made 114-icon core is joined
  ...
  devices, editing, status and more — all registered by default, same
  24×24 / 2px stroke style, hand-made names win on collision. Generated by
  `scripts/gen-icons.mjs` from `scripts/icons.json`. The icon docs page is a
  searchable, click-to-copy gallery, and the docs demos use real icons
  instead of emoji.
