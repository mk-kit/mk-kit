/**
 * Dependency-free syntax highlighting (used by mk-kit's code editor and
 * markdown renderer). Each function takes source text and returns an HTML
 * string of `<span class="mk-tok-…">` tokens. Input is HTML-escaped first,
 * so the result is safe to render.
 */
