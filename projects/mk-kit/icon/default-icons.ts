 ...
 * the glyphs an admin UI reaches for most often — 114 hand-made glyphs plus
 * the handful of Lucide-derived ones the library's own components render
 * (see default-icons.lucide.ts). Register your own with
 * `iconRegistry.register(name, svg)` / `registerIcons({...})`, or opt into
 * the larger Lucide-derived set with `provideMkExtendedIcons()` from
 * `@mk-kit/ui/icon/extended`.
 *
 ...
 */
import { LUCIDE_DEFAULT_ICON_BODIES } from './default-icons.lucide';

/**
 * Wraps SVG bodies with the shared `<svg>` attributes. Later maps win on a
 * shared name. Called once, marked pure, so the whole set is dropped from
 * bundles that never register it.
 */
const S = (...sets: ReadonlyArray<Readonly<Record<string, string>>>): Readonly<Record<string, string>> => {
...
export const MK_DEFAULT_ICONS: Readonly<Record<string, string>> = /* @__PURE__ */ S(LUCIDE_DEFAULT_ICON_BODIES, {
  ...
  'link-off': '<path d="M15 7h2a5 5 0 0 1 0 10h-2m-6 0H7A5 5 0 0 1 7 7h2"/><line x1="2" y1="2" x2="22" y2="22"/>',
  ...
  columns: '<rect x="4" y="3" width="7" height="18" rx="1"/><rect x="13" y="3" width="7" height="18" rx="1"/>',
  kanban: '<rect x="3" y="3" width="5" height="14" rx="1"/><rect x="9.5" y="3" width="5" height="10" rx="1"/><rect x="16" y="3" width="5" height="18" rx="1"/>',
  ...
  'cloud-upload': '<path d="M16 16l-4-4-4 4"/><path d="M12 12v9"/><path d="M20.39 18.39A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.3"/><path d="M16 16l-4-4-4 4"/>',
  ...
  'qr-code': '<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><line x1="14" y1="14" x2="14" y2="17"/><line x1="14" y1="21" x2="17" y2="21"/><line x1="21" y1="14" x2="21" y2="21"/><line x1="17" y1="14" x2="21" y2="14"/>',
  ...
  store: '<path d="M3 9l1.5-6h15L21 9"/><path d="M3 9h18v2a3 3 0 0 1-6 0 3 3 0 0 1-6 0 3 3 0 0 1-6 0z"/><path d="M5 13v8h14v-8"/><path d="M9 21v-5h6v5"/>',
  ...
  'circle-dot': '<circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="4" fill="currentColor" stroke="none"/>',
  'toggle-right': '<rect x="1" y="5" width="22" height="14" rx="7" ry="7"/><circle cx="16" cy="12" r="3"/>',
  'swap-vertical': '<polyline points="4 8 8 4 12 8"/><line x1="8" y1="4" x2="8" y2="20"/><polyline points="20 16 16 20 12 16"/><line x1="16" y1="20" x2="16" y2="4"/>',
  hourglass: '<path d="M6 2h12v4l-5 5v2l5 5v4H6v-4l5-5v-2L6 6z"/>',
  ban: '<circle cx="12" cy="12" r="10"/><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"/>',
  'search-off': '<circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="8" y1="8" x2="14" y2="14"/><line x1="14" y1="8" x2="8" y2="14"/>',
  ...
  megaphone: '<path d="M3 11l18-7v18l-18-7z"/><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6"/>',
